...
tools/github-actions/nanomap-renderer minimap -w 2040 -h 2040 "./_maps/maphispania_files/dadaby/dadaby.dmm"
...
mv "dadaby_nanomap_z1.png" "Dadaby_nanomap_z1.png"
cd "../../"
...
cp "data/nanomaps/Dadaby_nanomap_z1.png" "icons/_nanomaps"
