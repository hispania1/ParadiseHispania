#define ABOVELYING_MOB_LAYER 3.75

GLOBAL_LIST_INIT(hazard_overlays, list(
	"[NORTH]"	= new/image('modular_hispania/icons/effects/hazard_tape.dmi', icon_state = "N"),
	"[EAST]"	= new/image('modular_hispania/icons/effects/hazard_tape.dmi', icon_state = "E"),
	"[SOUTH]"	= new/image('modular_hispania/icons/effects/hazard_tape.dmi', icon_state = "S"),
	"[WEST]"	= new/image('modular_hispania/icons/effects/hazard_tape.dmi', icon_state = "W"),
	))
...
/obj/item/taperoll
	name = "police tape"
	icon = 'modular_hispania/icons/obj/policetape.dmi'
	icon_state = "tape"
