...
/mob/living/simple_animal/hostile/oldman
	...
	icon = 'modular_hispania/icons/mob/oldman.dmi'
	icon_state = "idle"
	icon_living = "oldman"
	incorporeal_move = 3
	...
	attack_sound = 'modular_hispania/sound/effects/oldman/gasp1.ogg'
	death_sound = 'modular_hispania/sound/effects/oldman/oldlaugh.ogg'
...
/mob/living/simple_animal/hostile/oldman/proc/giveObjective()
	if(mind)
		mind.wipe_memory()
		SEND_SOUND(src, 'modular_hispania/sound/effects/oldman/oldlaugh.ogg')
...
/mob/living/simple_animal/hostile/oldman/AttackingTarget()
	if(istype(target, /turf/simulated/wall))
		...
		if(T.rusted == TRUE)
			to_chat(src, "<span class ='warning'>You cannot use this rusted wall!</span>")
			return
		if(dimension)
			outdimension(T)
		else
...
/mob/living/simple_animal/hostile/oldman/get_blood_id()
	return "oil"
