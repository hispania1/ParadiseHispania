...
GLOBAL_LIST_INIT(AISwarmerCapsByType, list(/mob/living/simple_animal/hostile/swarmer/ai/resource = 5, /mob/living/simple_animal/hostile/swarmer/ai/ranged_combat = 3, /mob/living/simple_animal/hostile/swarmer/ai/melee_combat = 3))
...
/mob/living/simple_animal/hostile/megafauna/swarmer_swarm_beacon
	...
	icon = 'modular_hispania/icons/mob/swarmer.dmi'
	...
	var/swarmer_spawn_cooldown_amt = 30 SECONDS
