...
//HISPANIA PROHIBICIONES EXTRAS SWARMER
...
/obj/machinery/atmospherics/unary/cryo_cell/swarmer_act(mob/living/simple_animal/hostile/swarmer/S)
	to_chat(S, "<span class='warning'>No parece una buena idea impedir que las criaturas puedan curarse.</span>")
	return FALSE
