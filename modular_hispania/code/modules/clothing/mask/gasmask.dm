/obj/item/clothing/mask/gas/sechailer/cloaker
	...
	icon = 'modular_hispania/icons/obj/clothing/masks.dmi'
	icon_state = "cloaker"
	item_state = "cloaker"
	hispania_icon = TRUE
	sprite_sheets = list(
	"Vox" = 'modular_hispania/icons/mob/species/vox/mask.dmi',
	"Grey" = 'modular_hispania/icons/mob/species/grey/mask.dmi',
	"Unathi" = 'modular_hispania/icons/mob/species/unathi/mask.dmi',
	"Drask" = 'modular_hispania/icons/mob/species/drask/mask.dmi',
	"Tajaran" = 'modular_hispania/icons/mob/species/tajaran/mask.dmi')
