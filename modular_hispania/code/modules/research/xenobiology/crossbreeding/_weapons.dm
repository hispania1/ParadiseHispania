...
/obj/item/kitchen/knife/rainbowknife
	...
	icon = 'modular_hispania/icons/obj/slimecrossing.dmi'
	icon_state = "rainbowknife"
	item_state = "rainbowknife"
	righthand_file = 'modular_hispania/icons/mob/inhands/equipment/kitchen_righthand.dmi'
	lefthand_file = 'modular_hispania/icons/mob/inhands/equipment/kitchen_lefthand.dmi'
	force = 15
	throwforce = 15
	damtype = BRUTE
...
/obj/item/twohanded/required/adamantineshield/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
