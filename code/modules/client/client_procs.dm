...
#define UPLOAD_LIMIT		3485760	//Restricts client uploads to the server to 10MB //Boosted this thing. What's the worst that can happen?// MUCHO LAG ESO ES LO QUE PODRIA PASAR QUE ESPERABAS.El limite de ahora son 3MB, compriman su mierda.
